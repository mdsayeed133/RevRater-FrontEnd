  ...
  return (
    <div className="homepage">
      ...
      <p className="homepage-about">
        RevRater is a social media application developed as our team's Assigned
        Project. It is designed to be a service where you can rate employees of
        revature anonymously, giving them a score between 1-10. You give a
        rational behind your rating when you make a post about a specific
        employee. To be absolutely clear, this service is a lot like
        RateYourProfessor, a similar social media application, but with a focus
        specifically on Revature.
      </p>
      <div className="homepage-emp">
        <div className="homepage-emp-text">
          <div>Here are the Three Highed Rated Employees</div>
          {!top3Emp && <div className="homepage-emp-cards">Loading. . .</div>}
          {top3Emp && (
      ...
      <div className="homepage-join">
        {!loginUser && (
          <div className="homepage-join-text">
            <div>Join the RevRater Family</div>
            <button
            ...
            <div>Love RR? Let's make it official.</div>
          </div>
        )}
